...
# Attaching scroll bars to widget
from tkinter import *
from tkinter import ttk
root = Tk()
text = Text(root, width=40, height=10, wrap='word') # wrap configura a separação por palavras

# inserindo texto
text.insert('1.0', """Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
